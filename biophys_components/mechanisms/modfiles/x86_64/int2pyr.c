...
#define toggleVerbose toggleVerbose_int2pyr
 extern double toggleVerbose( _threadargsproto_ );
 /* declare global and static user variables */
#define nc_type_param nc_type_param_int2pyr
 ...
 "nc_type_param_int2pyr", &nc_type_param_int2pyr,
 0,0
};
