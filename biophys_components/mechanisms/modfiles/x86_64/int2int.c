...
#define toggleVerbose toggleVerbose_int2int
 extern double toggleVerbose( _threadargsproto_ );
 /* declare global and static user variables */
#define nc_type_param nc_type_param_int2int
 ...
 "nc_type_param_int2int", &nc_type_param_int2int,
 0,0
};
...
static const char* nmodl_file_text = 
  ...
  "    gmax         = .006  (uS) : weight conversion factor (from nS to uS)\n"
