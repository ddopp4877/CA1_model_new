...
#define nrn_init _nrn_init__ch_Navbis
#define _nrn_initial _nrn_initial__ch_Navbis
#define nrn_cur _nrn_cur__ch_Navbis
#define _nrn_current _nrn_current__ch_Navbis
#define nrn_jacob _nrn_jacob__ch_Navbis
#define nrn_state _nrn_state__ch_Navbis
#define _net_receive _net_receive__ch_Navbis 
#define _f_trates _f_trates__ch_Navbis 
#define rates rates__ch_Navbis 
#define states states__ch_Navbis 
#define trates trates__ch_Navbis 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ch_Navbis", _hoc_setdata,
 "rates_ch_Navbis", _hoc_rates,
 "states_ch_Navbis", _hoc_states,
 "trates_ch_Navbis", _hoc_trates,
 "vtrap_ch_Navbis", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ch_Navbis
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define hBetaV hBetaV_ch_Navbis
 double hBetaV = 9.5;
#define hBetaC hBetaC_ch_Navbis
 double hBetaC = 2;
#define hAlphV hAlphV_ch_Navbis
 double hAlphV = 62;
#define hAlphC hAlphC_ch_Navbis
 double hAlphC = 0.23;
#define mBetaV mBetaV_ch_Navbis
 double mBetaV = 10;
#define mBetaC mBetaC_ch_Navbis
 double mBetaC = 0.5;
#define mAlphV mAlphV_ch_Navbis
 double mAlphV = 38;
#define mAlphC mAlphC_ch_Navbis
 double mAlphC = -0.2;
#define usetable usetable_ch_Navbis
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ch_Navbis", 0, 1,
 0,0,0
};
 ...
 "hBetaC_ch_Navbis", "1",
 "hBetaV_ch_Navbis", "mV",
 "gmax_ch_Navbis", "mho/cm2",
 "g_ch_Navbis", "mho/cm2",
 "ina_ch_Navbis", "mA/cm2",
 "mtau_ch_Navbis", "ms",
 "htau_ch_Navbis", "ms",
 "myi_ch_Navbis", "mA/cm2",
 0,0
};
 ...
 "mAlphC_ch_Navbis", &mAlphC_ch_Navbis,
 "mAlphV_ch_Navbis", &mAlphV_ch_Navbis,
 "mBetaC_ch_Navbis", &mBetaC_ch_Navbis,
 "mBetaV_ch_Navbis", &mBetaV_ch_Navbis,
 "hAlphC_ch_Navbis", &hAlphC_ch_Navbis,
 "hAlphV_ch_Navbis", &hAlphV_ch_Navbis,
 "hBetaC_ch_Navbis", &hBetaC_ch_Navbis,
 "hBetaV_ch_Navbis", &hBetaV_ch_Navbis,
 "usetable_ch_Navbis", &usetable_ch_Navbis,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 ch_Navbis /home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/ch_Navbis.mod\n");
...
static int _reset;
static char *modelname = "sodium channel (voltage dependent, slightly higher threshold)";
...
static int _ode_count(int _type){ hoc_execerror("ch_Navbis", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 80 in file ch_Navbis.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/ch_Navbis.mod";
static const char* nmodl_file_text = 
