...
#define nrn_init _nrn_init__SEClampwd
#define _nrn_initial _nrn_initial__SEClampwd
#define nrn_cur _nrn_cur__SEClampwd
#define _nrn_current _nrn_current__SEClampwd
#define nrn_jacob _nrn_jacob__SEClampwd
#define nrn_state _nrn_state__SEClampwd
#define _net_receive _net_receive__SEClampwd 
#define icur icur__SEClampwd 
#define vstim vstim__SEClampwd 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 SEClampwd /home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/svclmpwd.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/svclmpwd.mod";
static const char* nmodl_file_text = 
  "TITLE svclmp.mod\n"
  "COMMENT\n"
  ...
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS SEClampwd\n"
  "	ELECTRODE_CURRENT i\n"
  "	RANGE dur1, amp1, dur2, amp2, dur3, amp3, rs,rsd, vc, i\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "	(nA) = (nanoamp)\n"
