...
#define nrn_init _nrn_init__ch_Kdrslow
#define _nrn_initial _nrn_initial__ch_Kdrslow
#define nrn_cur _nrn_cur__ch_Kdrslow
#define _nrn_current _nrn_current__ch_Kdrslow
#define nrn_jacob _nrn_jacob__ch_Kdrslow
#define nrn_state _nrn_state__ch_Kdrslow
#define _net_receive _net_receive__ch_Kdrslow 
#define _f_trates _f_trates__ch_Kdrslow 
#define rates rates__ch_Kdrslow 
#define states states__ch_Kdrslow 
#define trates trates__ch_Kdrslow 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_ch_Kdrslow", _hoc_setdata,
 "rates_ch_Kdrslow", _hoc_rates,
 "states_ch_Kdrslow", _hoc_states,
 "trates_ch_Kdrslow", _hoc_trates,
 "vtrap_ch_Kdrslow", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_ch_Kdrslow
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define usetable usetable_ch_Kdrslow
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_ch_Kdrslow", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "gmax_ch_Kdrslow", "mho/cm2",
 "g_ch_Kdrslow", "mho/cm2",
 "ik_ch_Kdrslow", "mA/cm2",
 "ntau_ch_Kdrslow", "ms",
 "myi_ch_Kdrslow", "mA/cm2",
 0,0
};
 ...
 "usetable_ch_Kdrslow", &usetable_ch_Kdrslow,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 ch_Kdrslow /home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/ch_Kdrslow.mod\n");
...
static int _reset;
static char *modelname = "Slow delayed rectifier potassium channel (voltage dependent)";
...
static int _ode_count(int _type){ hoc_execerror("ch_Kdrslow", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 74 in file ch_Kdrslow.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/dpd4k4/CA1_model/biophys_components/mechanisms/modfiles/ch_Kdrslow.mod";
static const char* nmodl_file_text = 
  ...
  "	(3) IK activates slowly (time constant, 20\n"
  "\n"
  "\n"
  "60 ms) in response to depolarizations positive to -40 mV and inactivates (about 5s) at -80 to -40 mV; it probably participates in spike repolarization.\n"
